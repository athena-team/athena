...
from athena.loss import Tacotron2Loss, GuidedMultiHeadAttentionLoss
...
from athena.utils.misc import generate_square_subsequent_mask, create_multihead_mask
...
class TTSTransformer(Tacotron2):
    ...
    def __init__(self, data_descriptions, config=None):
        ...
        attention_loss_function = GuidedMultiHeadAttentionLoss(self.hparams.guided_attn_weight,
                                                               self.reduction_factor, num_heads = self.hparams.num_heads)
