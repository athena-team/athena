# coding=utf-8
# Copyright (C) ATHENA AUTHORS; Xiangang Li; Shuaijiang Zhao; Ne Luo
#
...
import kaldiio
from .mpc_speech_set import MpcSpeechDatasetBuilder


class MpcSpeechDatasetKaldiIOBuilder(MpcSpeechDatasetBuilder):
    """MpcSpeechDatasetKaldiIOBuilder
       This data builder is a offline feature data builder and is used to mcp training
    """
